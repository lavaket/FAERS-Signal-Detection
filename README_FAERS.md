...
This project implements a reproducible pharmacoepidemiology signal-detection pipeline using real FAERS (FDA Adverse Event Reporting System) ASCII data.
...
Displays the a, b, c, and d cell counts from the 2×2 table.

---

# How to Run

1. Place all FAERS `.TXT` files into:
...
This project highlights key limitations of spontaneous reporting systems:

- No denominator  
- Underreporting and duplicate reporting  
- Reporting bias  
- Confounding by indication  
- Signals require formal follow-up studies  

FAERS signal detection generates **hypotheses**, not causal evidence.
